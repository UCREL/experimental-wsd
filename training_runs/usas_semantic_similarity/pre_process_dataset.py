...
if __name__ == "__main__":
    ...
    dataset = VariableMosaicoUSASTraining(base_model_name, tokenizer_kwargs={"add_prefix_space": True}, batch_size=1, num_dataloader_cpus=1, num_cpus_pre_processing=num_cpus_pre_processing, overwrite_all_pre_processed_data=overwrite, attention_pad_id=attention_pad_id)
